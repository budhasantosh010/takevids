...
| 14 | Real transcription + NVIDIA/LiteLLM reverse-engineering intelligence | BLOCKED | E4 transcript + model run + real kit files | Worker/substrate ready; 16 kHz audio extraction ready; no credentials/WhisperX/prompts yet | Need LiteLLM/NVIDIA credentials + WhisperX runtime + Santosh's exact prompts/skills |
